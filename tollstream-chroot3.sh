...
tollstream_chroot() {
  ...
  CHROOTDIR=/home/${SUDO_USER:-$USER}/Tollstream
...
printf "fi\n") >> /home/${SUDO_USER:-$USER}/Tollstream/etc/profile



chroot Tollstream /bin/ash -l

touch /home/${SUDO_USER:-$USER}/Tollstream/chrootInstall

}

CHROOTINSTALL=/home/${SUDO_USER:-$USER}/Tollstream/chrootInstall

VIRTUALMACHINE=/home/${SUDO_USER:-$USER}/Tollstream/virtualMachine

if [ -f "$CHROOTINSTALL" ]; then
