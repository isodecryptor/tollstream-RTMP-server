...
echo 'Gernerally, it is safe to allocate half your memory to a multi purpose computer such as a desktop or other multi task machines \n'
...
mkdir tollstream-alpine-x64-server

cd tollstream-alpine-x64-server
